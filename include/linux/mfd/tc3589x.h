...
#define TC3589x_KBDCODE1        0x0C
#define TC3589x_KBDCODE2        0x0D
#define TC3589x_KBDCODE3        0x0E
...
#define TC3589x_DKBDRIS		0xF0
#define TC3589x_DKBDMIS		0xF1
 ...
 * @irq_gpio:           GPIO pin number forIRQN
 * @irq_gpio_lshift:    LSHIFT GPIO pin number
 * @irq_gpio_rshift:    RSHIFT GPIO pin number
 * @irq_gpio_ctrl:      CTRL GPIO pin number
 * @irq_gpio_alt:       ALT GPIO pin number
 *
 */
struct tc3589x_platform_data {
	...
	void (*gpio_init)(void);
	int (*get_gpio_lshift)(void);
	int (*get_gpio_rshift)(void);
	int (*get_gpio_ctrl)(void);
	int (*get_gpio_alt)(void);
	u8  irq_gpio_lshift;
	u8  irq_gpio_rshift;
	u8  irq_gpio_ctrl;
	u8  irq_gpio_alt;
